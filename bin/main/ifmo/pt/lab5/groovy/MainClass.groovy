...
def db = [url: "jdbc:postgres://mhkojkgz:jTdRQ8aeWcYUt4oJlO95IUEq5WyhT47D@dumbo.db.elephantsql.com:5432/mhkojkgz", user: "mhkojkgz", password: "jTdRQ8aeWcYUt4oJlO95IUEq5WyhT47D"]
def sql = groovy.sql.Sql.newInstance(db.url, db.user, db.password, "org.postgresql.Driver")
def rows = sql.rows('select * from Item')
